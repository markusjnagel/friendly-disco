...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "simpleProc", name = "SimpleProc", hidden = true)
public class SimpleProcModelOutput implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<SimpleProcModel> {
    ...
    @Override()
    public SimpleProcModel toModel() {
        SimpleProcModel result = new SimpleProcModel();
        result.setId(getId());
